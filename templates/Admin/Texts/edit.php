...
$this->assign('title', __('Edit') . ' ' . __('Text'));
?>
				<div id="form-row" class="texts row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Text') ?></h3>
									<?= __('The data marked with <span class="fw-bold text-danger">*</span> must be provided!') ?>
								</div>

								<div class="float-end ms-5">
									<?= $this->Html->link('<span class="btn btn-outline-secondary mt-1 me-1"><i class="fa fa-times"></i></span>',
										["controller" => "Texts", "action" => "index", "_full" => true],
...
*/ ?>
							...
							<?= $this->Form->create($text, ['id' => 'main-form']) ?>
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<div class="mb-3 form-group row text required">
												...
												<div class="col-md-9">
													<?= $this->Form->control('lang', ['label' => __('Lang'), 'placeholder' => __('Lang'), 'class' => 'form-control', 'empty' => false]); ?>
											...
											<div class="mb-3 form-group row text required">
												...
												<div class="col-md-9">
													<?= $this->Form->control('slug', ['label' => __('Slug'), 'placeholder' => __('Slug'), 'class' => 'form-control', 'empty' => false]); ?>
