						...
						<div class="card mb-3">
							...
							<div class="card-header">
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-eye fa-spin"></i> <?= __('View') ?>: <?= __('Member') ?></h3>
...
<?php } ?>
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('About Title') ?>:</label>
												<div class="col-sm-10 p-1">
											...
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Link Facebook') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($member->link_facebook) ?>

												</div>
											</div>
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Link Twitter') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($member->link_twitter) ?>

												</div>
											</div>
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Link Instagram') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($member->link_instagram) ?>

												</div>
											</div>
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Link Linkedin') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($member->link_linkedin) ?>

												</div>
											</div>
<?php /*
											<div class="row"><!-- 6. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('About') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= $this->Text->autoParagraph(h($member->about)) ?>
...
*/ ?>
										...
										<!-- TAB for: About text field -->
										<div class="tab-pane fade" id="tabPanelAbout" role="tabpanel" aria-labelledby="tabAbout" tabindex="0">
											<div class="row">
												<div class="col-sm-12">
													<div class="row">
														<div id="readMoreAbout" class="col-sm-12 p-2 text read-more">
															<?= $this->Text->autoParagraph($member->about) ?>
