...
$this->assign('title', __('Add') . ' ' . __('Post'));
?>
						...
						<div class="card mb-3">
							<div class="card-header">
								...
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-plus fa-spin"></i> <?= __('Add') ?>: <?= __('Post') ?></h3>
...
<?php /*
											...
											<div class="mb-3 form-group row select required">
												...
												<div class="col-md-4">
													<?= $this->Form->control('user_id', ['options' => $myUsers, 'placeholder' => __('User Id'), 'class' => 'form-control select2', 'data-live-search' => false, 'data-container' => 'body', 'data-size' => '10', 'empty' => false, 'required' => true]); ?>
