						...
						<div class="card mb-3">
							...
							<div class="card-header">
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-eye fa-spin"></i> <?= __('View') ?>: <?= __('Gallery') ?></h3>
									<?= __('The data marked with <span class="fw-bold text-danger">*</span> must be provided!') ?>
								</div>
								<div class="float-end ms-5">
									<?= $this->Html->link('<span class="btn btn-outline-secondary mt-1 me-1"><i class="fa fa-times"></i></span>',
										["controller" => "Galleries", "action" => "index", "_full" => true],
...
<?php if (!empty($gallery->photos)) : ?>
												<li><?= $this->Html->link(__('Photos') . '...', ['controller' => 'Photos', 'action' => 'index', 'parent', 'gallery', $gallery->id], ['class' => 'dropdown-item']) ?></li>
<?php endif ?>
											</ul>
										</li>
...
<?php /*
											<div class="row"><!-- 6. -->
												...
												<div class="col-sm-10 p-1">
													<?= $this->Text->autoParagraph(h($gallery->body)) ?>
												...
												<div class="col-sm-12">
													<div class="row">
														<div id="readMoreBody" class="col-sm-12 p-2 text read-more">
															<?= $this->Text->autoParagraph($gallery->body) ?>
...
<?php if (!empty($gallery->photos)): ?>
											...
											<button class="nav-link<?= $acticeClass ?>" id="nav-photos-tab" data-bs-toggle="tab" data-bs-target="#nav-photos" type="button" role="tab" aria-controls="nav-photos" aria-selected="true">
												<?= __('Photos') ?>
											</button>
<?php 	$acticeClass = ""; ?>
<?php endif ?>
...
<?php if (!empty($gallery->photos)): ?>
									...
									<div class="tab-pane fade<?= $acticeClass ?> p-0" id="nav-photos" role="tabpanel" aria-labelledby="nav-photos-tab" tabindex="0">
...
<?php } ?>
													<th class="please-change-type gallery-id"><?= __('Gallery Id') ?></th>
...
<?php } ?>
													<td class="please-change-type gallery-id" value="<?= $photos->gallery_id ?>"><?= h($photos->gallery_id) ?></td>
