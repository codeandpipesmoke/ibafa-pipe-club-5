...
$this->assign('title', __('Edit') . ' ' . __('Gallery'));
?>
				<div id="form-row" class="galleries row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Gallery') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($gallery, ['id' => 'main-form']) ?>
