 ...
 * @var string[]|\Cake\Collection\CollectionInterface $galleries
 */
?>
<?php
...
$this->assign('title', __('Edit') . ' ' . __('Photo'));
?>
				<div id="form-row" class="photos row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Photo') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($photo, ['id' => 'main-form']) ?>
								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<!-- 1. SELECT: gallery_id: integer  required -->
											<div class="mb-3 form-group row select required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="gallery-id"><?= __('Gallery Id') ?>:</label>
												<div class="col-md-4">
													<?= $this->Form->control('gallery_id', ['options' => $galleries, 'placeholder' => __('Gallery Id'), 'class' => 'form-control select2', 'data-live-search' => false, 'data-container' => 'body', 'data-size' => '6', 'empty' => false]);	?>
