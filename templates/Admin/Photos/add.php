 ...
 * @var \Cake\Collection\CollectionInterface|string[] $galleries
 */
?>
<?php
...
$this->assign('title', __('Add') . ' ' . __('Photo'));
?>
						...
						<div class="card mb-3">
							<div class="card-header">
								...
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-plus fa-spin"></i> <?= __('Add') ?>: <?= __('Photo') ?></h3>
