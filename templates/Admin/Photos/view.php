...
<?php } ?>
											<div class="row"><!-- 1. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Gallery') ?>:</label>
												<div class="col-sm-10 p-1 link">
													<?= $photo->hasValue('gallery') ? $this->Html->link($photo->gallery->name, ['controller' => 'Galleries', 'action' => 'view', $photo->gallery->id]) : '' ?><span class="external-link-icon"><i class="fa fa-external-link" aria-hidden="true"></i></span>
												</div>
											</div>
											<div class="row"><!-- 2. -->
